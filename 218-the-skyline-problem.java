...
// [ [x1,y1], [x2, y2], [x3, y3], ... ]
// that uniquely defines a skyline. A key
...
// solution1: sort and TreeMap (to track all previous starts)
// [ [2, 9, 10], [3, 7, 15], [3, 5, 10] ]
// [ [2, 10, 0], [3, 15, 0], [3, 10, 0], [5, 10, 1], [7, 15, 1], [9, 10, 1] ]
// sort by
// - position
// - start first, end second
// - for start, tallest first
// - for end, lowest first
// we keep track of starts
// when we find an end,
...
// | | | | | |
// l l l r r r
// NOTE: we assume there is no 0 width building
class Solution {
